#Select three #Select three joints in a chain to orient them with x pointing down the chain and z orthogonal to their plane
#(first joint parented to world, second joint to first, third joint to second)
...
# Run the function
orient_three_joints()
joints in a chain to orient them with x pointing down the chain and z orthogonal to their plane
#(first joint parented to world, second joint to first, third joint to second)
